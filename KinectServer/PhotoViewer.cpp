...
HRESULT PhotoViewer::EnsureResources()
{
    HRESULT hr = S_OK;
...
/// </summary>
void PhotoViewer::DiscardResources( )
{
    SafeRelease(m_pRenderTarget);
...
bool PhotoViewer::Initialize( HWND hWnd, ID2D1Factory * pD2DFactory, int sourceWidth, int sourceHeight, int sourceStride )
{
    if ( NULL == pD2DFactory )
    {
        return false;
